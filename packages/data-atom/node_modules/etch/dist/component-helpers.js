...
var _getScheduler = require('./scheduler-assignment');
...
function initialize(component) {
  ...
  component.element = _createElement2['default'](component.virtualElement);
...
function update(component) {
  ...
  var scheduler = _getScheduler.getScheduler();
...
function updateSync(component) {
  ...
  _refsStack2['default'].push(component.refs);
  var newDomNode = _patch2['default'](component.element, _diff2['default'](oldVirtualElement, newVirtualElement));
  _refsStack2['default'].pop();
